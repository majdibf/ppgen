...
public class PlanningPromptBuilder {
    ...
    public String buildSystemPrompt() {
        return SystemPromptLibrary.withJsonDirective(SystemPromptLibrary.expertIntro("création de présentations professionnelles")
            + """
    ...
    /**
     * Output schema for plan generation (JSON Schema).
     */
